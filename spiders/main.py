...
def scrape():
    try:
        ...
        messagebox.showerror("HAMscrape","Unfortunatey some error ocured")
        return
    messagebox.showinfo("HAMscrape","SCRAPING SUCCESSFUL")


screen = Tk()
screen.title("HAMscrape")
screen.iconbitmap(f"{os.getcwd()}\\Icon\\flipkart_logo_icon.ico")
screen.geometry("700x300")
Label(screen, text="⏰TIME is your greatest ASSET⏰\n😊Let me save some of it for you MY FRIEND😊", font = (10),fg = 'green').pack()
